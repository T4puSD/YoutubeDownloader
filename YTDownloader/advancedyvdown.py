...
# DOWN_DIR_AUDIO=os.path.join(*Configuration['conf'].get('download_dir_audio').split(',')) # downloads
# DOWN_DIR_VIDEO=os.path.join(*Configuration['conf'].get('download_dir_video').split(','))
# TEMP_DIR = os.path.join(*Configuration['conf'].get('temp_dir').split(','))
FFMPEG_LOG = '-loglevel'
